...
@Api(tags = "系统功能-用户操作")
@AuthDefinition(name = "人员管理", path = "/system/user", authority = "sys:user", type = AccessType.MENU)
public class UserController extends BaseController{
    ...
    @PutMapping
    @ApiOperation("新增用户")
    @AuthDefinition(name = "新增用户", authority = "sys:user:add", type = AccessType.API)
    ...
    @ApiOperation("编辑用户")
    @PutMapping("/edit")
    @AuthDefinition(name = "编辑用户", authority = "sys:user:edit", type = AccessType.API)
    ...
    @PostMapping("/enable")
    @AuthDefinition(name = "变更用户状态", authority = "sys:user:enable", type = AccessType.API)
    ...
    @DeleteMapping
    @AuthDefinition(name = "删除用户", authority = "sys:user:del", type = AccessType.API)
