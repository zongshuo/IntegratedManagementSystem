...
public final class AnnotationUtil {
     ...
     * @return
     */
    public static Map<Class<? extends Annotation>, List<Annotation>> getAnnotations(Class targetClass){
        ...
        for (Annotation annotation : annotations){
            if (!baseMap.containsKey(annotation.annotationType())){
                baseMap.put(annotation.annotationType(), new ArrayList<Annotation>());
            }
            Collections.addAll(baseMap.get(annotation.annotationType()), targetClass.getAnnotationsByType(annotation.annotationType()));
            if (isJdkAnnotation(annotation.annotationType())) continue;
            baseMap.putAll(getAnnotations(annotation.annotationType()));
        }
