...
public class AnnotationData {
    ...
    public static AnnotationData getInstance(final Class clazz) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, NoSuchFieldException {
        ...
        return new AnnotationData(method.invoke(clazz));
    }
